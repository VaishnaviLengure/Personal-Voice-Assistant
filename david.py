...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('20511066.dypit@dypvp.edu.in', 'Montu@245')
    server.sendmail('20511066.dypit@dypvp.edu.in', to, content)
    server.close()
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'play song on youtube' in query:
            ...
            music_dir = r'C:\Users\vaish\Music'
            ...
            try:
                ...
                content = takeCommand()
                to = "vaishnavilengure2018@gmail.com"
            ...
            speak('your personal assistant is shutting down,Good bye mam we will meet soon')
            print('your personal assistant is shutting down,Good bye mam we will meet soon')
            exit()